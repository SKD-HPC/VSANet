...
class CaptionModel(nn.Module):
    ...
    def beam_search(self, init_state, symptom_feature, init_logprobs, *args, **kwargs):
        ...
        for t in range(self.max_seq_length + group_size - 1):
            for divm in range(group_size):
                if t >= divm and t <= self.max_seq_length + divm - 1:
                    ...
                    logprobs_table[divm], state_table[divm] = self.get_logprobs_state(it.cuda(),symptom_feature, *(
